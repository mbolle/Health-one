...
<main class='container'>
    <div class='p-4 p-md-5 mb-4 text-white rounded '>
        <div class=' px-0'>
            <h1 class='display-4 fst-italic text-warning'>Welcome <?php echo ($_SESSION['user'][0]->name)?></h1> <!--insert user name here-->
        </div>
        <?php
        ...
        <div class="row">
            ...
            <div class="col-12 text-dark">
                <?php
                echo "<span class='text-dark'>Uw Wachtoord:</span><b><span class='text-dark hidden-password'> $password</span></b>";
                ?>
            </div>
        </div>
