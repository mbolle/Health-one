...
<div class="container">
    ...
    <?php } elseif ($reviewGiven['result'] === true){ ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>TOP! dank je wel!</strong> We gaan je review op de website zetten!
        </div>
    <?php } ?>
    ...
    <form method="POST">
        ...
        <div class=" mt-3">
             <button type="submit" name="verzenden" class="form-group btn btn-outline-warning">verstuur je review</button>
        </div>
        </form>
